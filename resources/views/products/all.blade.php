...
<section class="max-w-7xl mx-auto pb-14">
    ...
    <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8 md:mb-10">
        ...
        <div>
            ...
            <p class="uppercase tracking-[4px] text-[11px] text-[#8B5E3C] mb-3">
                Our Collection
            </p>

            <h1 class="hero-title text-3xl md:text-5xl font-bold text-[#2B2B2B] leading-tight">
        ...
        <form method="GET"
            ...
            <div class="bg-white border border-[#E8DED1] rounded-[28px] p-3 flex flex-col md:flex-row gap-3 shadow-sm">
                ...
                <!-- BUTTON -->
                <button class="bg-[#7D5548] hover:bg-[#68453A] transition text-white px-6 py-3 rounded-2xl text-sm font-medium">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4 md:gap-6">
        ...
        <div class="group bg-white rounded-[28px] overflow-hidden border border-[#EFE7DC] shadow-sm hover:shadow-xl transition duration-300">
            ...
            <div class="p-4 md:p-5">
                ...
                <!-- CATEGORY -->
                <p class="text-[10px] md:text-xs uppercase tracking-[3px] text-[#B08968] mb-2">
                ...
                <div class="mb-4">
                    ...
                    <h4 class="text-lg md:text-2xl font-bold text-[#7D5548]">

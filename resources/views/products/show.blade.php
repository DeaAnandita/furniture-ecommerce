...
<style>
    ...
    .primary-btn{
        background: linear-gradient(135deg, #8B5E3C, #6F472D);
        transition: .3s ease;
    }
...
<section class="max-w-7xl mx-auto ">
    ...
    <div class="flex items-center gap-2 text-sm text-gray-500 mb-6 md:mb-8">
        ...
        <span class="text-[#8B5E3C] font-medium line-clamp-1">
            {{ $product->name }}
        </span>
...
<div class="product-wrapper rounded-[28px] overflow-hidden grid lg:grid-cols-2 max-w-7xl mx-auto">
    ...
    <!-- IMAGE -->
    <div class="relative bg-gradient-to-br from-[#EFE4D7] via-[#F5EEE6] to-[#E6D4C1] p-4 md:p-5 flex items-center justify-center overflow-hidden">
    ...
    <div class="p-5 md:p-7 flex flex-col justify-center">
        ...
        <div class="mb-3">
            ...
            <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#F6EEE5] text-[#8B5E3C] text-[10px] md:text-xs uppercase tracking-[2px] font-medium">
        ...
        <div class="mb-5">
            ...
            <h2 class="text-xl md:text-2xl font-bold text-[#8B5E3C]">

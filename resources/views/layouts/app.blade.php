        ...
        <div class="flex items-center justify-between h-[78px]">
            ...
            <div class="flex items-center gap-10">
                ...
                <a href="/"
                   class="flex items-center gap-3 group">
                    ...
                    <div class="w-11 h-11 rounded-full bg-[#8B5E3C] text-white flex items-center justify-center shadow-md text-lg">
                ...
                <div class="hidden md:flex items-center gap-7 text-[15px]">
                    ...
                    <a href="/"
                       class="nav-link font-medium hover:text-[#8B5E3C] transition">
                        Home
                    </a>
            ...
            <div class="hidden md:flex items-center gap-3">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="/login"
                       class="px-5 py-2.5 rounded-full font-medium border border-[#D9CBB8] bg-white hover:bg-[#F5EFE6] transition text-sm">

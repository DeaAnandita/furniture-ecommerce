...
<section class="min-h-screen bg-[#F8F5F1] py-10 px-4">
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-10">
            ...
            <h1 class="text-3xl md:text-5xl font-bold text-[#2B2B2B]">
                Payment Details
            </h1>
        ...
        <div class="grid lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-[32px] border border-[#E8DED1] p-6 md:p-8 shadow-sm">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="flex justify-between items-center pb-5 border-b border-[#EFE7DC]">
                ...
                <div class="bg-white rounded-[32px] border border-[#E8DED1] p-6 shadow-sm sticky top-28">
                    ...
                    <div class="border-t border-[#EFE7DC] pt-5 mb-6">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-2xl font-bold text-[#8B5E3C]">
                    ...
                    <button id="pay-button"
                            class="w-full bg-[#8B5E3C] hover:bg-[#6F472D] transition text-white py-4 rounded-2xl font-medium text-lg">
